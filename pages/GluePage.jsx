...
const GluePage = () => {
  ...
  const fetchProducts = (sortBy) => (dispatch) => {
    axios
      .get('https://perekrostok-backend-production-6738.up.railway.app/api/products?category=1')
      .then(({ data }) => {
  ...
  return (
    <>
      <Head>
        <title>Перекресток Лысково клеи</title>
        <meta name="description" content="Магазин 'Перекресток' клеи" />
        <meta property="og:title" content="Клеи магазина 'Перекресток'" />
      </Head>
      <Header />
        ...
        <div className="section__products__container">
          <div className="section__products__nav__top">
            <span className="section__products__nav__top__left">
              <span className="section__products__nav__top__left-title">Клеи</span>
            </span>
